...
public class MyLaunchAdapter extends RecyclerView.Adapter<MyLaunchAdapter.MyViewHolder> {
    ...
    public MyLaunchAdapter(Context context, List<Meal> mealList) {
    ...
    @NonNull
    @Override
    public MyLaunchAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.meal_card, parent, false);
        MyLaunchAdapter.MyViewHolder myViewHolder = new MyLaunchAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull MyLaunchAdapter.MyViewHolder holder, int position) {
