...
public class AdapterForCountry extends RecyclerView.Adapter<AdapterForCountry.MyViewHolder>{
    ...
    public AdapterForCountry(Context context, List<Ingredients> ingredientsList){
